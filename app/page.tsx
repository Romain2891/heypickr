        ...
        {pickr ? (
          <>
            <div ref={containerRef} style={{ flex: 1, position: 'relative', overflow: 'hidden', cursor: 'col-resize', userSelect: 'none' as const, minHeight: 0 }}
              ...
              {showHint && (
                <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', zIndex: 20, pointerEvents: 'none', display: 'flex', alignItems: 'center', gap: 10 }}>
                  <div style={{ background: 'rgba(8,8,8,0.85)', border: '0.5px solid rgba(201,168,76,0.5)', borderRadius: 24, padding: '8px 16px', display: 'flex', alignItems: 'center', gap: 8 }}>
                    <span style={{ color: '#C9A84C', fontSize: 14 }}>←</span>
                    <div style={{ display: 'flex', flexDirection: 'column' as const, alignItems: 'center', gap: 2 }}>
                      <span style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: 16, letterSpacing: 4, color: '#fff' }}>PICK ONE</span>
                      <span style={{ fontSize: 8, letterSpacing: 2, color: '#555', textTransform: 'uppercase' as const }}>slide to explore · tap to vote</span>
                    </div>
                    <span style={{ color: '#C9A84C', fontSize: 14 }}>→</span>
                  </div>
                </div>
